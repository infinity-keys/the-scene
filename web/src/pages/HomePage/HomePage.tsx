    ...
    <>
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-md flex-col justify-center gap-6 p-4">
        ...
        <div className="grid h-full max-h-[472px] w-full flex-1 grid-cols-1 gap-3">
          <Link
            className="relative block h-full w-full rounded bg-[linear-gradient(to_bottom_right,rgba(0,0,0,0.51),rgba(0,0,0,.2)),url('/images/ShareImage.webp')] bg-cover text-lg text-white shadow hover:shadow-white"
            to={routes.share()}
          >
          ...
          <Link
            className="relative block h-full w-full rounded bg-[linear-gradient(to_bottom_right,rgba(0,0,0,0.51),rgba(0,0,0,.1)),url('/images/FindImage.webp')] bg-cover text-lg text-white shadow hover:shadow-white"
            to={routes.find()}
          >
